...
DEMO1 
The following figures show an example confusion matrix comparison before/after transfer learning. Generated by [examples/test_texas_transferlearning.py](https://github.com/aaspip/eqpolarity/blob/main/demos/test_texas_transferlearning.py)
...
DEMO2
The following figures show an example of plotting waveforms and polarity labels for the Texas dataset. Generated by [examples/test_plot_waveforms_and_polarity.py](https://github.com/aaspip/eqpolarity-torch/blob/main/demos/test_plot_waveforms_and_polarity.py)
