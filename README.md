...
DEMO1 
The following figures show an example confusion matrix comparison before/after transfer learning. Generated by [examples/test_texas_transferlearning.py](https://github.com/aaspip/eqpolarity/blob/main/examples/test_texas_transferlearning.py)
