...
# Local libraries
from .legacy import in_pol as in_pol # Reading polarity inputs
from .legacy import in_sta as in_sta # Reading station files
from .legacy import in_sp as in_sp # Reading S/P ratios
from .legacy import in_qc as in_qc # Quality control of user inputs
from .legacy import in_other as in_other # Functions for reading other inputs
from .legacy import fun as fun # Computing mechanisms
from .legacy import out as out # Output functions
from .legacy import gridsearch_so as gridsearch_so # For creating fortran gridsearch module
from .legacy import compute_mech as compute_mech # For computing mechanism
...
def SKHASH():
	...
	if p_dict['use_fortran']:
		gridsearch_spec = importlib.util.find_spec("pyhash.legacy.gridsearch")
		if (gridsearch_spec is not None):
			from .legacy import gridsearch as gridsearch
