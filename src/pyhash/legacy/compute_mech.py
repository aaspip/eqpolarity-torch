...
from . import gridsearch_so # For creating fortran gridsearch module
from . import out # Output functions
from . import fun # Computing mechanisms
...
def compute_mech(event_x,num_events,event_id,event_pol_df,p_dict,lookup_dict,qual_criteria_dict,cat_df,dir_cos_dict):
	...
	if p_dict['outfolder_plots']:
		from . import plot_mech # For plotting mechanism solutions
